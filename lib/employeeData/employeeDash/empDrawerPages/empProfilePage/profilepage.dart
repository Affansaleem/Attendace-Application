...
import 'package:project/adminData/adminDash/adminDrawerbuilding/admindash/adminScreens/admin_page.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Center(
                          child: Container(
                            padding: const EdgeInsets.all(
                                10), // Adjust the padding for the grid
                            child: GridView(
                              gridDelegate:
                                  const SliverGridDelegateWithFixedCrossAxisCount(
                                crossAxisCount: 3,
                                crossAxisSpacing:
                                    10.0, // Reduce the spacing horizontally
                                mainAxisSpacing:
                                    10.0, // Reduce the spacing vertically
                              ),
                              shrinkWrap: true, // Make it scrollable
                              children: [
                                _buildField("Name", employeeProfile.empName),
                                _buildField(
                                    "Email", employeeProfile.emailAddress),
                                _buildField(
                                    "Shift Code", employeeProfile.shiftCode),
                                _buildField(
                                    "Date of Join",
                                    employeeProfile.dateofJoin
                                        .toString()), // You may need to format this date
                                _buildField(
                                    "Employee Code", employeeProfile.empCode),
                              ],
                            ),
                          ),
                        ),
                        ...
                        // Menu
                        // const tileWidget(title: 'Edit Profile', icon: Icons.settings),
